...
<div className={styles.description}>חשוב לי להדגיש שאתה מגיע למרחב של חופש מוחלט עבורך שמהווה עבורך את האפשרות להביא את עצמך בצורה טבעית ואמיתית.
זהו מרחב נטול שיפוטיות מלא בקבלה מלאה, ואהבה ללא תנאי.
אני כאן להחזיק מרחב ריפוי ובהירות
תוך כדי ניקוי מה שמוחזק באופן לא מודע והעצמה אישית ליצירת חדש בחייך.
ביחד, נפוגג ונשחרר את מה שחוסם ועומד בדרך,
בינך לבין בחירה חדשה ומימוש שלה בפועל.
